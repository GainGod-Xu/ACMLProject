import pandas as pd
from Utils.CMRPConfig_YL import CMRPConfig
...
out_dir = 'experiments/saved_models_34k'
...
def main():
    ...
    # graph_model = GraphEmbeddingGCN(CMRPConfig.mr2_model_num_node_features, CMRPConfig.mr2_model_hidden_channels,
    #                                 CMRPConfig.mr2_model_embedding).to(CMRPConfig.device)
    ...
    # print('initialize and load models', time.time() - t)
    # t = time.time()
